      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            CommentBox(
              commenter: context.appState.myUser!,
...
class __CommentTileState extends State<_CommentTile> {
  late final userData = MyUser.fromMap(widget.reaction.user!.data!);
          ...
          children: [
            Padding(
              ...
              child: (widget.isReplyToComment)
                  ? Avatar.tiny(myUser: userData)
                  : Avatar.small(myUser: userData),
            ),
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
