...
class PostCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final userData = MyUser.fromMap(actorData as Map<String, dynamic>);
              ...
              onTap: () {
                ...
                Navigator.of(context).push(
                  CommentsScreen.route(
                    ...
                    activityOwnerData: MyUser.fromMap(map),
                  ),
                );
              },
...
class _ProfilePicture extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final myUser = context.watch<AppState>().myUser;
    if (myUser == null) {
