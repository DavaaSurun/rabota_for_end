...
class AppTheme {
  ...
  ThemeData get darkTheme => _darkBase.copyWith(
        ...
        brightness: Brightness.dark, colorScheme: _darkBase.colorScheme.copyWith(secondary: AppColors.secondary).copyWith(background: AppColors.dark),
      );
  ...
  ThemeData get lightTheme => _lightBase.copyWith(
        ...
        brightness: Brightness.light, colorScheme: _lightBase.colorScheme.copyWith(secondary: AppColors.secondary).copyWith(background: AppColors.light),
      );
}
