...
class AppState extends ChangeNotifier {
  ...
  /// The extraData from [user], mapped to an [MyUser] object.
  ...
  /// HARDCODED LIKE THIS.
  Future<bool> connect(AppUser demoUser) async {
    ...
    if (currentUser.data != null) {
      _myUser = MyUser.fromMap(currentUser.data!);
  ...
  ///
  /// This will call [notifyListeners] and update the local [_myUser] state.
  Future<void> updateProfilePhoto(String filePath) async {
    ...
    if (_myUser != null) {
      await client.currentUser!.update(_myUser!.toMap());
    }
